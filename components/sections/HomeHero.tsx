...
export default function HomeHero() {
  ...
  return (
    <div
      className="container relative w-full py-20 md:py-36"
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center">
        <div className="w-full lg:w-3/5 text-left">
          <h1 className="text-8xl font-bold mb-4">
            <p className="flex items-center text-xl space-x-2">
              ...
              <span className="text-5xl lg:text-8xl hidden md:inline">AI Designs</span>
            </p>
            <span className="text-5xl lg:text-8xl">AI Designs</span>
            <p className="text-5xl lg:text-8xl lg:!leading-[5rem]">That create the <br /> perfect room for <br /> you.</p>
          </h1>
          ...
          <div className="flex space-x-4">
            <Link href={`/sign-up`}>
              <button
                className="group relative overflow-hidden text-white py-3 px-8 rounded-xl text-md md:text-xl font-semibold"
            ...
            <button className="group relative overflow-hidden border border-blue-600 text-black bg-[#9ef0ff] py-3 px-8 rounded-xl text-md md:text-xl font-semibold">
              <span className="block transition-transform duration-300 ease-in-out transform group-hover:translate-y-[-150%]">
                More About us
              </span>
              <span className="absolute left-[50%] top-full -translate-x-[50%] w-full transition-transform duration-300 ease-in-out transform group-hover:translate-y-[-150%]">
        ...
        {/* Images Section */}
        <div
          className="w-full lg:w-2/5 flex justify-center items-center mt-20 lg:mt-0"
        >
          <div className="relative w-full max-w-2xl">
            <div
              className="absolute -top-10 right-0 w-32 h-32 lg:w-[23rem] lg:h-64 bg-cover rounded-[2rem] md:rounded-[4rem] border-8 border-cyan-300 z-10"
              style={{
            ...
            />
            <div
              className="absolute -bottom-10 left-0 w-32 h-32 lg:w-[23rem] lg:h-64 bg-cover rounded-[2rem] md:rounded-[4rem] border-8 border-cyan-300 z-10"
              style={{
            ...
            />
            <div className="relative w-full h-52 lg:w-[32rem] lg:h-[22rem] bg-cover rounded-l-[2.5rem] border-l-[15px] border-cyan-400"
              style={{
                background:
                  "url('/hero/1.jpeg')",
                backgroundPosition: "center",
            ...
            <div className="absolute bottom-2 left-8 h-20 w-20 md:h-32 md:w-32 z-10">
              <div
