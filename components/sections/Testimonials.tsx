      ...
      <section className="bg-gradient-to-b from-blue-900 to-black py-16 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-10 md:grid-cols-10 lg:grid-cols-10 gap-6">
            {/* Testimonial 1 */}
            <div className="col-span-7 bg-[#0e3152] h-full flex items-center justify-center p-4 rounded-3xl">
            ...
            <div className="col-span-3 bg-[#0e3152] h-[22rem] w-full p-3 rounded-3xl">
              <img
